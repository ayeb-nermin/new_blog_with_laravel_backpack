...
class PortfolioCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/portfoliocategory');
        CRUD::setEntityNameStrings('portfoliocategory', 'portfolio_categories');
    }
    ...
    {
        CRUD::setValidation(PortfolioCategoryRequest::class);
